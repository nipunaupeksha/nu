...
const IconVehicleBMW = ({
  ...
  >
    <path
      id="Shape"
      className="st1"
      d="M135.5,17.5C69.5,17.5,16,71,16,137s53.5,119.5,119.5,119.5S255,203,255,137
...
S247.2,75.3,247.2,137z"
    ...
    <g id="Group" transform="translate(7.304985, 3.108504)">
      <path
        id="W_60_"
        className="st1"
        d="M186.1,83.2c1.6,1.7,4,4.6,5.3,6.3l24.2-15.4c-1.2-1.6-3.1-4-4.6-5.7l-15.3,10.1l-1,0.9
...
l14.5-7.5l0.9-0.7l-0.7,0.9L186.1,83.2z"
      ...
      <path
        id="M_60_"
        className="st1"
        d="M131.2,52.6l6.6-14.8l0.4-1.3l-0.1,1.4l0.7,19.8c2.3,0.2,4.7,0.5,7.1,0.9l-1.1-29.3
...
l0.7-19.8l-0.1-1.4l0.4,1.3l6.6,14.8H131.2z"
      ...
      <path
        id="B_x5F_22d_60_"
        className="st1"
        d="M77.7,75.9c3.8-4,6-8.7,2.2-13.1c-2.1-2.4-5.6-2.9-8.5-1.7l-0.3,0.1l0.1-0.3
...
c0.9-0.4,1.9-0.5,2.8,0.1c0.9,0.6,1.3,1.6,1.1,2.6c-0.3,1.2-1.2,2.3-2,3.2c-1.1,1.2-10.4,11.1-10.4,11.1L58.9,78.8z"
    ...
    <path
      className="st2"
      d="M135.5,66.2V137H64.7C64.7,97.8,96.3,66.2,135.5,66.2z"
      fill={color}
      strokeLinecap={strokeLinecap}
      strokeLinejoin={strokeLinejoin}
    />
    <path
      className="st2"
      d="M206.3,137c0,39.2-31.7,70.8-70.8,70.8V137H206.3z"
      fill={color}
      strokeLinecap={strokeLinecap}
      strokeLinejoin={strokeLinejoin}
    />
