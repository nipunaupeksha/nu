...
const IconVehicleAlfaRomeo = ({
  ...
  >
    <path
      d="M1250,0C559.7,0,0,559.7,0,1250s559.7,1250,1250,1250s1250-559.6,1250-1250C2500,559.7,1940.4,0,1250,0z M1250,2475
C573.5,2475,25,1926.5,25,1250C25,573.5,573.5,25,1250,25S2475,573.5,2475,1250C2475,1926.5,1926.5,2475,1250,2475z"
    ...
    />
    <polygon
      points="340.7,868.8 371.7,794.1 422,815.1 365,952 136.7,857.1 162.7,794.8 340.7,868.8 "
      fill={color}
      strokeLinecap={strokeLinecap}
      strokeLinejoin={strokeLinejoin}
    />
    <polygon
      points="417.2,495.1 447.7,522.9 497.6,468.3 537.8,505 487.9,559.7 559.5,625.1 514,674.9 331.5,508.2 432,398.2 
472.2,434.8 417.2,495.1 "
    ...
    />
    <polygon
      points="1975.5,310.6 2023.9,356.1 1971.6,488.4 2102.8,430.5 2151.7,476.5 2020.4,696.6 1972.1,649.5 2045.4,520.5 
2044.9,520.1 1902,580.9 1882.4,562.5 1936.6,418.1 1936.1,417.6 1813.9,499.6 1764.5,454.1 1975.5,310.6 "
    ...
    />
    <polygon
      points="2291.4,816.6 2253.2,832.4 2282.4,902.7 2232.1,923.5 2202.9,853.3 2163.6,869.6 2194.3,943.7 2144.1,964.5 
2087.5,828.1 2315.8,733.4 2372.4,869.8 2322.1,890.6 "
    ...
    />
    <path
      d="M318.9,1175.9l0.9-72l-248.3,94.8l-0.9,73.7l246,102.8l0.9-71.6l-42.8-18.4l1.1-92.9L318.9,1175.9z M225.6,1266l-78.3-28.8
v-0.7l79-26.6L225.6,1266z"
    ...
    />
    <path
      d="M737.8,187.7l-65.3,34.2l26.3,265.3l63.4-33.2l-4.1-46.3l82.3-43.2l34.9,30.3l63.7-33.4L737.8,187.7z M751.8,355.4
L740,272.8l0.6-0.3h0h0h0l60.9,56.9L751.8,355.4z"
    ...
    />
    <path
      d="M1208.9,216.6c36.2-9.1,53.8-40.1,51.1-74.1c-4.1-52.6-44.8-72.8-95.9-68.7l-100.5,8l19.6,246.3l67.3-5.3l-7.5-94.7l0.7,0
...
C1192.4,178.8,1168,184.7,1146.1,186.4z"
    ...
    />
    <path
      d="M1617.2,119.6c-71.1-22.9-152.8,5.9-175.7,77.1c-24.5,76.2,15.5,148.3,94.8,173.8c79.3,25.5,154-9.7,178.5-85.9v0
...
c-0.7-0.2-1.4-0.4-2-0.7c-37.9-12.9-58.1-54.1-45.2-92h0c10.5-32.5,51.5-52,89.9-39.6C1636.4,191.2,1658.3,231,1647.9,263.5z"
    ...
    />
    <path
      d="M2440.9,1210.8c-2.6-74.7-57.4-141.6-132-139.1c-80,2.8-134.2,65-131.4,148.2c2.9,83.3,61.4,141.6,141.3,138.8
...
c-0.7-40,31.2-73,71.3-73.7c34.1-1.2,66.4,30.7,67.7,71C2380.1,1253.2,2350.1,1287.2,2316,1288.4z"
    ...
    />
    <path
      d="M1250,349.5c-497.3,0-900.5,403.2-900.5,900.5s403.2,900.5,900.5,900.5h0c497.3,0,900.5-403.1,900.5-900.5
...
C2127.2,1731,1740.4,2121.5,1260.5,2127.2z"
    ...
    />
    <path
      d="M1507,742.7h319v-33.2h-319V742.7z M1507,681.8h319v-25.4h-319V681.8z M1532.5,642L1532.5,642z M1598.9,642L1598.9,642z
...
L1615.5,1940.5z"
    ...
    />
    <path
      d="M1527.5,943.2c-52.1,24.4-64.8,97.4-62.1,122.9l-73,50.4c-9.7,10.5-26,11.2-36.5,1.5s-11.2-26-1.5-36.5c0.5-0.5,1-1,1.5-1.5
...
export default IconVehicleAlfaRomeo;
